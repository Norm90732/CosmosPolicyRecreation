...
from engine.eval.rolloutWorkers import (
    CosmosInferencePolicyServer,
    HDF5Writer,
    distributedRobocasaWorker,
)
...
def runRollOutCollection(cfg: DictConfig):
    ...
    HDF5WriterObj = HDF5Writer.remote( # pyrefly:ignore
        cfgDict, cfg.inference.rolloutSaveDir
    )  
